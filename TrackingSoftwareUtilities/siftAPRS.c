  ...
  for (j=0;j<50000;j++)
    {
      ...
      /* open log file */
      fpi=fopen("APRS_2456489.log","r");	// must change this line everytime
...
", an end of file or run out of room then stop. */
      ...
      fclose(fp2);      
      fclose(fp3);      
            system("cp kc9lhwtrack.txt ../TrackingSoftware");
        system("cp kc9ligtrack.txt ../TrackingSoftware");
       system("cp wb9skytrack.txt ../TrackingSoftware");
      sleep(10);
